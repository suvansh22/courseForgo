/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 53b6bbc6c3b4ad907aca9e1c90d3d242)
...
declare namespace Cloudflare {
	interface Env {
		...
		ENABLE_CLOUDFLARE_DEV: string;
		GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY: string;
		GOOGLE_SERVICE_ACCOUNT_CLIENT_EMAIL: string;
		ENABLE_DRIVE_TEST_API: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTAUTH_URL" | "NEXTAUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "ENABLE_CLOUDFLARE_DEV" | "GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY" | "GOOGLE_SERVICE_ACCOUNT_CLIENT_EMAIL" | "ENABLE_DRIVE_TEST_API">> {}
}
